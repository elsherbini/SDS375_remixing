...
What's going on with the `Gained` column? Why are values strings and not numbers?
...
This kind of thing happens all the time in metadata tables. Important not to confuse similar columns!
